...
describe('Header', () => {
  beforeEach(() => {
    ...
    mockUseSidebarData.mockReturnValue({
      ...
      conversations: [],
      externalApps: [],
      loadingStates: { 'chat-agents': false, 'workflows': false, 'chat-widgets': false, 'external-apps': false, conversations: false },
      errorStates: { 'chat-agents': null, 'workflows': null, 'chat-widgets': null, 'external-apps': null, conversations: null },
      fetchChatAgents: vi.fn(),
      fetchWorkflows: vi.fn(),
      fetchChatWidgets: vi.fn(),
      fetchExternalApps: vi.fn(),
